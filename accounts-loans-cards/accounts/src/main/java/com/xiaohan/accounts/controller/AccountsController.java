...
public class AccountsController {
  ...
  public CustomerDetails myCustomerDetails(@RequestHeader("xiaohanbank-correlation-id") String correlationid,@RequestBody Customer customer) {
  ...
  private CustomerDetails myCustomerDetailsFallBack(@RequestHeader("xiaohanbank-correlation-id") String correlationid,Customer customer, Throwable t) {
    Accounts accounts = accountsRepository.findByCustomerId(customer.getCustomerId());
    List<Loans> loans = loansFeignClient.getLoansDetails(correlationid,customer);
    CustomerDetails customerDetails = new CustomerDetails();
    customerDetails.setAccounts(accounts);
  ...
  public String sayHello() {
    return "Hello, Welcome to xiaohanBank Kubernetes cluster";
  }
